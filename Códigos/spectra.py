...
def oiii (x, a, b, c, d, e, f, g, h, i, j):
    w_oiii1 = (x - a)/b
    ...
    r1 = j 
    return r1 + c*alpha_oiii1/b + f*alpha_oiii2/e + i*alpha_hbeta/h

guess_oiii = np.array([center_oiii1, 1, 1, center_oiii2, 1, 1, center_hbeta, 1, 1, 10])
...
def halpha (x, a, b, c, d, e, f, g, h, i, j):
    w_halpha = (x - a)/b
    ...
    r2 = j  
    return r2 + c*alpha_halpha/b + f*alpha_nii1/e + i*alpha_nii2/h

guess_halpha = np.array([center_halpha, 1, 1, center_nii1, 1, 100, center_nii2, 0.1, 1, 10])
...
def oii (x, a, b, c, d, e, f, g):
    w_oii1 = (x - a)/b
    alpha_oii1 = (1./math.sqrt(2.*math.pi))*np.exp((-w_oii1**2.)/2.)
    w_oii2 = (x - d)/e
    alpha_oii2 = (1./math.sqrt(2.*math.pi))*np.exp((-w_oii2**2.)/2.)
    r3 = g
    return r3 + c*alpha_oii1/b + f*alpha_oii2/e

guess_oii = np.array([center_oii1, 1, 1, center_oii2, 1, 1, 10])
