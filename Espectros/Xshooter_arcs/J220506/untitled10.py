...
#Dados 2D
hdu_list = fits.open('J220506_1_SCI_SLIT_FLUX_MERGE2D_NIR.fits')
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,3)
x3 = plt.imshow(image_data, vmin=-0.118e-18, vmax=1.548e-18)
plt.xticks(x_pos, x_label)
...
plt.subplot(3,2,4)
plt.plot(lam3, cube3)
x4 = plt.imshow(image_data, vmin=-0.118e-18, vmax=1.548e-18)
plt.xticks(x_pos, x_label)
