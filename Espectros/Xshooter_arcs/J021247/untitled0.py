...
#Dados 2D
hdu_list = fits.open('J021247_1_SCI_SLIT_FLUX_MERGE2D_NIR.fits')
...
plt.subplot(3,2,2)
x2 = plt.imshow(image_data, vmin=-1.118e-18, vmax=0.848e-18)
plt.xticks(x_pos, x_label)
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,3)
x3 = plt.imshow(image_data, vmin=-3.118e-18, vmax=0.548e-18)
plt.xticks(x_pos, x_label)
...
plt.subplot(3,2,4)
plt.plot(lam3, cube3)
x4 = plt.imshow(image_data, vmin=-3.118e-18, vmax=0.548e-18)
plt.xticks(x_pos, x_label)
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,5)
x5 = plt.imshow(image_data, vmin=-5.118e-18, vmax=1.548e-18)
plt.xticks(x_pos, x_label)
