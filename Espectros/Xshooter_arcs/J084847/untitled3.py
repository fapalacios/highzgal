...
file_ir = 'J084847_1_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
file_vis = 'J084847_1_SCI_SLIT_FLUX_MERGE1D_VIS.fits'
...
guess = np.array([10, 10, 10, 10, cen_oiii1, 1000*cen_oiii1/(2.99798*1e5), 500, 500, 500, 500, 500, 500])
...
#Dados 2D
hdu_list = fits.open('J084847_1_SCI_SLIT_FLUX_MERGE2D_NIR.fits')
hdu_listv = fits.open('J084847_1_SCI_SLIT_FLUX_MERGE2D_VIS.fits')
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,3)
x3 = plt.imshow(image_data, vmin=-1.118e-18, vmax=1.248e-18)
plt.xticks(x_pos, x_label)
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,5)
x5 = plt.imshow(image_datav, vmin=-0.118e-18, vmax=1.548e-18)
