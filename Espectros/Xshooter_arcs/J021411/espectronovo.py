...
plt.xlim(center_oiii1 - 20, center_oiii1 + 20)
plt.ylim(0, 150)
...
plt.plot(lam2, cube2)
x1 = lam2
y1 = (a4 + amp_hbeta*(1./math.sqrt(2.*math.pi))*np.exp((-((x1 - cen_hbeta)/sigma_hbeta)**2.)/2.)/sigma_hbeta )
plt.plot(x1,y1, color = 'red')
plt.xlim(cen_hbeta - 20, cen_hbeta + 20)
plt.ylim(0, 140)
plt.title('H\u03b2')
...
plt.xlim(center_oii1 - 20, center_oii2 + 20)
plt.ylim(0, 250)
