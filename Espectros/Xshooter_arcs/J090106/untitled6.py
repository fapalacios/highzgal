...
file_ir = 'J090106_1_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
file_vis = 'J090106_1_SCI_SLIT_FLUX_MERGE1D_VIS.fits'
...
guess = np.array([10, 10, 10, 10, cen_oiii1, 50*cen_oiii1/(2.99798*1e5), 1000, 1000, 1000, 1000, 1000, 1000])
...
#Dados 2D
hdu_list = fits.open('J090106_1_SCI_SLIT_FLUX_MERGE2D_NIR.fits')
hdu_listv = fits.open('J090106_1_SCI_SLIT_FLUX_MERGE2D_VIS.fits')
...
plt.subplot(3,2,1)
x1 = plt.imshow(image_data, vmin=-1.118e-18, vmax=0.848e-18)
...
plt.subplot(3,2,2)
x2 = plt.imshow(image_data, vmin=-3.118e-18, vmax=1.948e-18)
plt.xticks(x_pos, x_label)
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,3)
x3 = plt.imshow(image_data, vmin=-1.118e-18, vmax=1.548e-18)
plt.xticks(x_pos, x_label)
