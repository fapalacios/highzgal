...
plt.subplot(3,2,2)
x2 = plt.imshow(image_data, vmin=-1.118e-18, vmax=2.548e-18)
plt.xticks(x_pos, x_label)
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,3)
x3 = plt.imshow(image_data, vmin=-3.118e-18, vmax=1.548e-18)
plt.xticks(x_pos, x_label)
...
#plt.figure(figsize=(2,4))
plt.subplot(3,2,5)
x5 = plt.imshow(image_data, vmin=-0.018e-18, vmax=1.548e-18)
plt.xticks(x_pos, x_label)
