...
file_ir = 'J095921_1_SCI_SLIT_FLUX_MERGE1D_NIR.fits'
file_vis = 'J095921_1_SCI_SLIT_FLUX_MERGE1D_VIS.fits'
...
guess = np.array([10, 10, 10, 10, cen_oiii1, 40*cen_oiii1/(2.99798*1e5), 1000, 1000, 1000, 1000, 1000, 1000, 16225])

#ajuste das funções aos dados    
p, pv = curve_fit(gauss, lam_fin, cube_fin, guess, sig, bounds = (0, [np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,16225]))
...
#Dados 2D
hdu_list = fits.open('J095921_1_SCI_SLIT_FLUX_MERGE2D_NIR.fits')
...
plt.subplot(3,2,2)
x2 = plt.imshow(image_data, vmin=-0.118e-18, vmax=0.548e-18)
plt.xticks(x_pos, x_label)
