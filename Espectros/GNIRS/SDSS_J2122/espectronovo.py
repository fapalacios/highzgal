...
plt.xlim(center_oiii1 - 35, center_oiii1 + 35)
plt.ylim(-10, 400)
...
plt.xlim(center_hbeta - 30, center_hbeta + 30)
plt.ylim(20, 120)
plt.title('H\u03b2')
...
plt.xlim(center_halpha - 30, center_halpha + 30)
plt.ylim(-5, 200)
...
y2 = (a2 + amp_halpha*(1./math.sqrt(2.*math.pi))*np.exp((-((x2 - center_halpha)/sigma_halpha)**2.)/2.)/sigma_halpha
     + amp_nii1*(1./math.sqrt(2.*math.pi))*np.exp((-((x2 - center_nii1)/sigma_nii1)**2.)/2.)/sigma_nii1
     + amp_nii2*(1./math.sqrt(2.*math.pi))*np.exp((-((x2 - center_nii2)/sigma_nii2)**2.)/2.)/sigma_nii2)
plt.xlim(center_nii1 - 30, center_nii1 + 30)
plt.ylim(-5, 100)
plt.plot(x2,y2, color = 'red')
plt.title('[NII]')
...
#plt.xlim(center_oii1 - 5, center_oii2 +5)
#plt.ylim(0, 100)
